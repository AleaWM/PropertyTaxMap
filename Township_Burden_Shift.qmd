...
taxbills_by_Class_per_TC <- read_csv("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/ptax/2_Summed_Bills_by_Taxcode_and_Class.csv")  %>% 
  mutate(tax_code = as.character(tax_code)) 


exemptions_by_class_per_TC <- read_csv("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/ptax/3_Exemptions_Details_output-ClassTaxcodeExemps.csv") %>%
...
class_dict <- read_csv("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/ptax/class_dict_expanded.csv")
...
**Exemptions within each Townships:**
...
```{r eval = FALSE}
TC_bills_current <- read_csv("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/ptax/2_Summed_Bills_by_Taxcode_and_Class.csv") %>% 
  filter(class != "0") %>% 
  mutate(tax_code = as.character(tax_code),
...
# write_csv(Current_Taxrates, "Township_Composite_Taxrates.csv")

```

```{r}

Current_Taxrates <- read_csv("Township_Composite_Taxrates.csv")
Current_Taxrates
...
class8Townships = read_csv("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/ptax/3_Exemptions_Details_output-ClassTaxcodeExemps.csv") %>% 
  mutate(class_code = as.character(class_code)) %>%
  filter(class_code >=800 & class_code <900) %>%
  left_join(class_dict) %>%
  mutate(tax_code_num = as.character(tax_code_num)) %>%
...
C8_exemptions <- read_csv("C:/Users/aleaw/OneDrive/Documents/PhD Fall 2021 - Spring 2022/Merriman RA/ptax/3_Exemptions_Details_output-ClassTaxcodeExemps.csv") %>% 
  mutate(class_code = as.character(class_code)) %>%
  filter(class_code !=0) %>%
  left_join(class_dict) %>%
  mutate(tax_code_num = as.character(tax_code_num)) %>%
